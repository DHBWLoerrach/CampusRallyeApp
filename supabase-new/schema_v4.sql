...
ALTER TABLE ONLY "public"."voting_votes"
    ADD CONSTRAINT "voting_votes_no_self_vote" CHECK ("voting_team_id" <> "voted_for_team_id");
...
CREATE INDEX "voting_votes_rallye_question_idx"
    ON "public"."voting_votes" USING "btree" ("rallye_id", "question_id");


CREATE INDEX "voting_votes_target_idx"
    ON "public"."voting_votes" USING "btree" ("rallye_id", "question_id", "voted_for_team_id");
...
REVOKE ALL ON FUNCTION "public"."finalize_voting_for_question"(bigint, bigint) FROM PUBLIC;
REVOKE ALL ON FUNCTION "public"."finalize_voting_for_question"(bigint, bigint) FROM "anon";
REVOKE ALL ON FUNCTION "public"."finalize_voting_for_question"(bigint, bigint) FROM "authenticated";
GRANT ALL ON FUNCTION "public"."finalize_voting_for_question"(bigint, bigint) TO "service_role";


REVOKE ALL ON FUNCTION "public"."auto_finalize_voting"() FROM PUBLIC;
REVOKE ALL ON FUNCTION "public"."auto_finalize_voting"() FROM "anon";
REVOKE ALL ON FUNCTION "public"."auto_finalize_voting"() FROM "authenticated";
GRANT ALL ON FUNCTION "public"."auto_finalize_voting"() TO "service_role";


GRANT ALL ON FUNCTION "public"."cast_voting_vote"(bigint, bigint, bigint, bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."cast_voting_vote"(bigint, bigint, bigint, bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."cast_voting_vote"(bigint, bigint, bigint, bigint) TO "service_role";


GRANT ALL ON FUNCTION "public"."get_voted_voting_question_ids"(bigint, bigint) TO "anon";
GRANT ALL ON FUNCTION "public"."get_voted_voting_question_ids"(bigint, bigint) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_voted_voting_question_ids"(bigint, bigint) TO "service_role";
...
REVOKE ALL ON TABLE "public"."voting_votes" FROM "anon";
REVOKE ALL ON TABLE "public"."voting_votes" FROM "authenticated";
GRANT ALL ON TABLE "public"."voting_votes" TO "service_role";


REVOKE ALL ON TABLE "public"."voting_finalization" FROM "anon";
REVOKE ALL ON TABLE "public"."voting_finalization" FROM "authenticated";
