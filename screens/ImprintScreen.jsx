      ...
      <View style={[
        ...
        <View style={globalStyles.imprintStyles.texts.block}>
          <Text style={{ color: isDarkMode ? Colors.darkMode.text : Colors.lightMode.text }}>
            ...
            {'\n'}
            {'\n'}
            {language === 'de' ? 'Umsatzsteuer-Identifikationsnummer gemäß §27a Umsatzsteuergesetz: DE287664832' : 'VAT identification number according to §27a VAT Act: DE287664832'}
          </Text>
        </View>
        <View style={globalStyles.imprintStyles.texts.block}>
          <Text style={[
            ...
            {language === 'de' ? 'Rechtsform und zuständige Aufsichtsbehörde' : 'Legal form and responsible supervisory authority'}
          </Text>
          <Text style={{ color: isDarkMode ? Colors.darkMode.text : Colors.lightMode.text }}>
            {language === 'de' ? 'Die Duale Hochschule Baden-Württemberg ist nach § 1 Abs. 1 DH-ErrichtG vom 12.12.2008 eine rechtsfähige Körperschaft des öffentlichen Rechts und zugleich staatliche Einrichtung. Die Duale Hochschule Baden-Württemberg Lörrach ist nach § 1 Abs. 2 DH-ErrichtG vom 12.12.2008 eine rechtlich unselbständige Untereinheit dieser Hochschule.' : 'The Duale Hochschule Baden-Württemberg is a legal entity under public law and a state institution according to § 1 Abs. 1 DH-ErrichtG of 12.12.2008. The Duale Hochschule Baden-Württemberg Lörrach is a legally dependent subunit of this university according to § 1 Abs. 2 DH-ErrichtG of 12.12.2008.'}
            {'\n'}
            {'\n'}
            {language === 'de' ? 'Dienstanbieter im Sinne des TDG bzw. des MDStV ist als Träger der Dualen Hochschule das Land Baden-Württemberg vertreten durch die Ministerin für Wissenschaft, Forschung und Kunst Theresia Bauer, MdL.' : 'Service provider in the sense of the TDG or the MDStV is the state of Baden-Württemberg, represented by the Minister for Science, Research and Art Theresia Bauer, MdL.'}
            {'\n'}
            {'\n'}
            {language === 'de' ? 'Zuständige Aufsichtsbehörde:' : 'Responsible supervisory authority:'}
            {'\n'}
            {language === 'de' ? 'Ministerium für Wissenschaft, Forschung und Kunst' : 'Ministry of Science, Research and Art'}
            {'\n'}
            ...
            {'\n'}
            {language === 'de' ? 'Telefon: +49 711 279 - 0' : 'Phone: +49 711 279 - 0'}
            {'\n'}
            {language === 'de' ? 'Telefax: +49 711 279 - 3081' : 'Fax: +49 711 279 - 3081'}
            {'\n'}
            {language === 'de' ? 'poststelle@mwk.bwl.de' : 'poststelle@mwk.bwl.de'}
            {'\n'}
            {language === 'de' ? 'http://www.mwk.bwl.de' : 'http://www.mwk.bwl.de'}
          </Text>
        </View>
        <View style={globalStyles.imprintStyles.texts.block}>
          <Text style={[
        ...
        <View style={globalStyles.imprintStyles.texts.block}>
          ...
          <Text style={{ color: isDarkMode ? Colors.darkMode.text : Colors.lightMode.text }}>
            {language === 'de' ? 'Der Quellcode dieser App wurde als Open Source Projekt angelegt' : 'The source code of this app was created as an open source project'}
          </Text>
          <Text
