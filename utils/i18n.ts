...
export const translations = {
  de: {
    ...
    'puzzle.fragment.tasks': 'Beantworte erst die Teilfragen',
    'puzzle.fragment.progress': '{{completed}} von {{total}} beantwortet',
    'puzzle.fragment.answer': 'Beantworten',
    'puzzle.fragment.completed': 'Erledigt',
    'puzzle.fragment.surrendered': 'Aufgegeben',
    'puzzle.fragment.next': 'Zur nächsten Teilfrage',
    'puzzle.backToPuzzle': 'Zurück zur Übersicht',
    ...
    'sorting.error.incompleteMessage': 'Bitte ordne alle Elemente zu, bevor du die Antwort sendest.',
    'sorting.confirm.message': 'Willst du deine Zuordnung wirklich abschicken?',
    'sorting.instruction': 'Wähle zuerst einen Ort aus, dann tippe auf die passenden Elemente. Tippe erneut, um eine Zuordnung aufzuheben.',
    'sorting.primaryItems': 'Kategorien',
    'sorting.secondaryItems': 'Wähle passende Elemente',
    'sorting.assignTo': 'Wird zugeordnet zu: {{name}}',
  ...
  en: {
    ...
    'puzzle.fragment.tasks': 'Answer the sub-questions first',
    'puzzle.fragment.progress': '{{completed}} of {{total}} answered',
    'puzzle.fragment.answer': 'Answer',
    'puzzle.fragment.completed': 'Completed',
    'puzzle.fragment.surrendered': 'Given up',
    'puzzle.fragment.next': 'To next sub-question',
    'puzzle.backToPuzzle': 'Back to overview',
    'puzzle.fragmentsRemaining': '{{count}} fragment(s) remaining',
    'puzzle.submit': 'Check',
    'sorting.error.loadPairs': 'Sorting pairs could not be loaded.',
    'sorting.error.incompleteMessage': 'Please assign all items before submitting your answer.',
    'sorting.confirm.message': 'Do you really want to submit your assignment?',
    'sorting.instruction': 'First select a location (top), then tap the matching items (bottom). Tap again to remove an assignment.',
    'sorting.primaryItems': 'Locations / Categories',
    'sorting.secondaryItems': 'Items to assign',
    'sorting.assignTo': 'Assigning to: {{name}}',
