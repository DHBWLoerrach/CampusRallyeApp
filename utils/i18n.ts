...
export const translations = {
  de: {
    ...
    'rallye.status.ranking': 'Rangliste',
    ...
    'nfc.scan.cta': 'NFC-Tag scannen',
    'nfc.scan.reading': 'Tag wird gelesen…',
    'nfc.scan.holdNear': 'Bitte halte den NFC-Tag an dein Gerät.',
    'nfc.correctMessage': 'Der NFC-Tag ist korrekt!',
    'nfc.error.notSupported': 'NFC wird auf diesem Gerät oder Build nicht unterstützt.',
    'nfc.error.answerKeyMissing': 'Für diese NFC-Frage ist noch kein erwarteter NFC-String hinterlegt.',
    'nfc.error.noData': 'Es konnte kein lesbarer String vom NFC-Tag gelesen werden.',
    'nfc.error.incorrect': 'Der NFC-Tag ist falsch!',
    'nfc.error.readFailed': 'NFC-Tag konnte nicht gelesen werden. Bitte erneut versuchen.',
    'nfc.manual.cta': 'Antwort manuell eingeben',
    'nfc.manual.title': 'Manuelle NFC-Antwort',
    'nfc.manual.description': 'NFC ist nicht verfügbar. Gib den erwarteten String manuell ein.',
    'nfc.manual.placeholder': 'NFC-String eingeben',
    'nfc.manual.submit': 'Absenden',
    'nfc.manual.error.empty': 'Bitte gib einen Wert ein.',
  },
  en: {
    'common.ok': 'OK',
    ...
    'nfc.scan.cta': 'Scan NFC tag',
    'nfc.scan.reading': 'Reading tag…',
    'nfc.scan.holdNear': 'Please hold the NFC tag near your device.',
    'nfc.correctMessage': 'The NFC tag is correct!',
    'nfc.error.notSupported': 'NFC is not supported on this device or build.',
    'nfc.error.answerKeyMissing': 'No expected NFC string is configured for this NFC question yet.',
    'nfc.error.noData': 'No readable string could be read from the NFC tag.',
    'nfc.error.incorrect': 'The NFC tag is incorrect!',
    'nfc.error.readFailed': 'Could not read NFC tag. Please try again.',
    'nfc.manual.cta': 'Enter answer manually',
    'nfc.manual.title': 'Manual NFC answer',
    'nfc.manual.description': 'NFC is unavailable. Enter the expected string manually.',
    'nfc.manual.placeholder': 'Enter NFC string',
    'nfc.manual.submit': 'Submit',
    'nfc.manual.error.empty': 'Please enter a value.',
  },
} as const;
