...
export const translations = {
  de: {
    ...
    'welcome.join.select': 'Rallyes anzeigen',
    ...
    'welcome.selectDepartment.description': 'Studiengänge mit aktiven Rallyes',
    ...
    'welcome.campusEvents.description': 'Rallyes für standortweite Veranstaltungen',
  ...
  en: {
    ...
    'welcome.join.select': 'Show rallyes',
    ...
    'welcome.selectDepartment.description': 'Departments with active rallyes',
